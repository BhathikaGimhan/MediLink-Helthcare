...
import { Star, MessageCircle, Users, Bot } from 'lucide-react';
    ...
    <div className="space-y-12">
      ...
      >
        ...
        <p className="text-xl text-gray-400 max-w-2xl mx-auto">
          The future of healthcare ratings is here. Connect with top medical professionals
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h3 className="text-xl font-semibold mb-2 text-cyan-400">Transparent Ratings</h3>
            <p className="text-gray-400">Our platform ensures authentic reviews from verified patients.</p>
          </div>
          <div>
            <h3 className="text-xl font-semibold mb-2 text-cyan-400">AI-Powered Matching</h3>
            <p className="text-gray-400">Let our AI help you find the perfect healthcare provider.</p>
          </div>
        </div>
      </motion.div>
    </div>
